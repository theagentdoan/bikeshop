    ...
    <div className="header">
      ...
      <div className="top-nav">		
        ...
        <ul className="nav">
          ...
          <li className="dropdown1"><NavLink to="/signin">SIGN IN</NavLink>
           
          </li>             
          <li className="dropdown1"><NavLink to="404.html">EXTRAS</NavLink>
            
          </li>
          <NavLink className="shop" to="/cart"><img src="images/cart.png" alt=""/><span id="cart-count" className="badge badge-light">0 </span></NavLink>
          <br></br>
          <li ><label ><input className="search-bar" type="search" placeholder="Search"></input></label></li>
        </ul>
      </div>
